...
CONFIG_YAML="${CONFIG_YAML:-${REPO_ROOT}/scripts/config/vlajepa_robot_ft_canonical_multi_subset_a100x8_smoke.yaml}"
...
RUN_ID="${RUN_ID:-robot_ft_canonical_multi_subset_a100x8_smoke_$(date +%Y%m%d_%H%M%S)}"
