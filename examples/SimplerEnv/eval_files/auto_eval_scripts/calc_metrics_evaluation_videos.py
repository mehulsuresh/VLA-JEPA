...
CKPT_MAPPING = {
    ...
    "QWenACT": "steps_120000_pytorch_model.pt", 
}
...
parser.add_argument(
    ...
    help="checkpoint file path (e.g. .../checkpoints/steps_xxx_pytorch_model.pt)",
)
parser.add_argument(
    "--log-dir-root",
    type=str,
    default=None,
    help="root directory containing evaluation outputs; default: <dirname(model_path)>/google_robot_eval",
)
