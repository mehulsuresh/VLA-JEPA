...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--action-norm-mode", choices=("auto", "min_max", "q99", "q01_q99_unclipped", "mean_std"), default="auto")
    parser.add_argument("--state-norm-mode", choices=("auto", "min_max", "q99", "q01_q99_unclipped", "mean_std"), default="auto")
...
def _infer_once(
    *,
    ...
    policy_action_chunk = realman_policy_actions_to_absolute(
        policy_action_chunk,
        current_state,
        action_type=action_type,
    )
    current_lift_height_mm = float(current_state[-1])
